...
const BentoCard: React.FC<BentoCardProps> = ({ title, description, src }) => {
    return (
        <div className='relative size-full'>
            ...
            <div className='relative z-10 flex size-full flex-all justify-between p-5 text-blue-50'>
                <div>
        ...
        <section className='bg-black pb-52'>
            <div className='container mx-auto px-3 md:px-10'>
                <div className='px-5 py-32'>
                    ...
                    <p className="max-w-md font-circular-web text-lg text-blue-50 opacity-50">Immerse yourself in a rich and ever-expanding universe, where a vibrant array of products converge into an interconnected overlay experiance on your world</p>
                ...
                <div className='grid h-[135vh] w-full grid-cols-2 grid-rows-3 gap-7'>
                    ...
                    <div className="bento-tile_1 ms-32 row-span-1 md:col-span-1 md:ms-0">
                        <BentoCard
                            ...
                            title={<>n<b>e</b>xus</>}
                            description='A gamified social hub, adding a new dimesion of play to social interaction for Web3 communities.'
                        />
                    ...
                    <BentoTilt className="bento-tile_1 me-14 md:col-span-1 md:me-0">
                        <BentoCard
                            ...
                            title={<>az<b>u</b>l</>}
                            description='A cross world AI agent- elevating your gameplay t be more fun and productive.'
                        />
                    ...
                    <div className='bento-tilt_2'>
                        <div className='flex size-full flex-col justify-between bg-violet-300 p-5'>
                            <h1 className='bento-title special-font max-w-64 text-black'>Mor<b>e</b > Coming S<b>oo</b>n!</h1>
